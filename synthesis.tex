...
\rampal{There are several papers that use new elements of DAISIE; these should be added. Also, DAISIE was only launched with the Ecology Letters paper}
...
\rampal{I have not read the razzo ms yet, but I think that you should say a bit more about how relevant the model is. In the razzo ms you should review the literature on the species pump which is the idea underlying MBD and empirical support for it. Then you can refer back to it here.} 
...
\rampal{You already have quite some text about these two new methods. Can you use this to extend the discussion here a bit more?}
...
\rampal{Also, here you can add some of the figures you produced, explaining how mainland extinction changes the way DAISIE would interpret the data.}
